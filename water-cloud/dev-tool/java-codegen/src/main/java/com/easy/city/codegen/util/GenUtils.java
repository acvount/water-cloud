...
import com.easy.city.codegen.core.constant.CommonConstants;
import com.easy.city.codegen.core.exception.CheckedException;
import com.easy.city.codegen.entity.ColumnEntity;
import com.easy.city.codegen.entity.GenConfig;
import com.easy.city.codegen.entity.TableEntity;
...
public class GenUtils {
    ...
    private final String Group_JAVA_VM = "Group.java.vm";
    ...
    private List<String> getTemplates() {
        ...
        templates.add("template/Group.java.vm");
    ...
    private String columnToJava(String columnName) {
		...
		for(int i = 0; i < len; ++i) {
			...
			if (0==i) {
				buffer.append(String.valueOf(ch).toLowerCase());
			} else {
				buffer.append(ch);
			}
		}
    ...
    private String getFileName(String template, String className, String packageName, String moduleName) {
        ...
        if (template.contains(ENTITY_JAVA_VM)) {
            return packagePath + File.separator + moduleName + File.separator + "entity" + File.separator + className + ".java";
        }

        if (template.contains(MAPPER_JAVA_VM)) {
            return packagePath + File.separator + moduleName + File.separator + "mapper" + File.separator + className + "Mapper.java";
        }
        ...
        if (template.contains(Group_JAVA_VM)) {
            return packagePath + File.separator + moduleName + File.separator + "group" + File.separator + className + "Group.java";
        }

        if (template.contains(MAPPER_XML_VM)) {
            return CommonConstants.BACK_END_PROJECT + File.separator + "src" + File.separator + "main" + File.separator + "resources" + File.separator + "mapper" + File.separator + moduleName + File.separator + className + "Mapper.xml";
        }
